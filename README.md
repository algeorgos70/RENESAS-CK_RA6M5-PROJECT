...
The platform that I used for training the AI was EDGE IMPULSE, where i created 4 different classes (RED, GREEN, BLUE, Unknown) using the microphone of my laptop and the on board microphone. For the consol log i used the Teraterm app.

CODE: If you open the src/ei_main.cpp you can find the variable ei_run_impulse() its the location where the code runs.
DISCLAIMER: Due to the files being to large, download both zips and combine them in one before importing the project to e2studio
